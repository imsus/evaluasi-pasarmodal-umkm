<md-toolbar>
	<div class="md-toolbar-tools">
		...
		<span><a href="/">Home</a> <svg viewBox="0 0 24 24" style="height:24;width:24"><path fill="#000000" d="M8.6 16.6L13.2 12 8.6 7.4 10 6 16 12 10 18 8.6 16.6Z"/></svg> <span>{{ 'location.href' }}</span></span>
		<!-- fill up the space between left and right area -->
		<span flex></span>
		@if (Auth::user())
			<md-button href="/logout" class="md-raised md-warn" style="display: flex; align-items: center">
		...
		@else
			<md-button href="/login" class="md-accent md-raised" style="display: flex; align-items: center">

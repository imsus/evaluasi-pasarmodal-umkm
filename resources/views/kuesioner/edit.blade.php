	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="btn-group btn-group-justified page-navigation" style="margin: 55px 0px 0px 0px">
				...
				<div class="btn-group"><a href="/kuesioner-new/detail/{{ $kuesioner->id }}" type="button" class="btn btn-success"><span class="fal fa-check"></span> Detil</a></div>
				<div class="btn-group"><a href="/kuesioner-new/delete/{{ $kuesioner->id }}" type="button" class="btn btn-danger" onclick="return window.confirm('Data akan dihapus secara permanen.\nApakah Anda Yakin?')"><span class="fal fa-trash"></span></a></div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('status_usaha', App\Questionnaire::$status_usaha_option, $kuesioner->status_usaha, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('status_pemodalan', '10. Status Investasi/Pemodalan') }}
				{{ Form::select('status_pemodalan', App\Questionnaire::$status_pemodalan_option, $kuesioner->status_pemodalan, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
		...
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('dokumen_akte', App\Questionnaire::$dokumen_akte_option, $kuesioner->dokumen_akte, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				{{ Form::select('sm_punya', App\Questionnaire::$sm_punya_option, $kuesioner->sm_punya, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_sertifikasi', '18. Apakah Sistem Manajemen Mutu perusahaan anda mendapat sertifikasi?') }}
				{{ Form::select('sm_sertifikasi', App\Questionnaire::$sm_sertifikasi_option, $kuesioner->sm_sertifikasi, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_so', '19. Apakah Koperasi/perusahaan anda memiliki struktur organisasi?') }}
				{{ Form::select('sm_so', App\Questionnaire::$sm_so_option, $kuesioner->sm_so, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_jobdesc', '20. *Jika Ya, apakah disertai dengan uraian tugas dan fungsi untuk seluruh bagian?') }}
				{{ Form::select('sm_jobdesc', App\Questionnaire::$sm_jobdesc_option, $kuesioner->sm_jobdesc, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_sop', '21. Apakah Koperasi/perusahaan anda memiliki SOP?') }}
				{{ Form::select('sm_sop', App\Questionnaire::$sm_sop_option, $kuesioner->sm_sop, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_arsip', '22. Apakah Koperasi/perusahaan anda memiliki sistem pengarsipan?') }}
				{{ Form::select('sm_arsip', App\Questionnaire::$sm_arsip_option, $kuesioner->sm_arsip, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_audit', '23. Apakah Koperasi/perusahaan anda melakukan internal audit secara berkala?') }}
				{{ Form::select('sm_audit', App\Questionnaire::$sm_audit_option, $kuesioner->sm_audit, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_tqc', '24. Apakah perusahaan melakukan total quality control dari bahan baku sampai ke produk?') }}
				{{ Form::select('sm_tqc', App\Questionnaire::$sm_tqc_option, $kuesioner->sm_tqc, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sm_satisfaction', '25. Apakah perusahaan anda memperhatikan kepuasan pelanggan?') }}
				{{ Form::select('sm_satisfaction', App\Questionnaire::$sm_satisfaction_option, $kuesioner->sm_satisfaction, array('class' => 'form-control')) }}
			</div>
			<h3>Kelengkapan sarana dan prasarana</h3>
			<div class="form-group">
				{{ Form::label('sarana_luas_kantor', '26. Berapakah luas bangunan tempat kerja dan kantor?') }}
				{{ Form::select('sarana_luas_kantor', App\Questionnaire::$sarana_luas_kantor_option, $kuesioner->sarana_luas_kantor, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_kondisi_kantor', '27. Bagaimana kondisi bangunan tempat kerja dan kantor?') }}
				{{ Form::select('sarana_kondisi_kantor', App\Questionnaire::$sarana_kondisi_kantor_option, $kuesioner->sarana_kondisi_kantor, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_nilai_kantor', '28. Berapa perkiraan nilai bangunan tempat kerja dan kantor?') }}
				{{ Form::select('sarana_nilai_kantor', App\Questionnaire::$sarana_nilai_kantor_option, $kuesioner->sarana_nilai_kantor, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_luas_gudang', '29. Berapa luas bangunan gudang? ') }}
				{{ Form::select('sarana_luas_gudang', App\Questionnaire::$sarana_luas_gudang_option, $kuesioner->sarana_luas_gudang, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_kondisi_gudang', '30. Bagaimana kondisi bangunan gudang?') }}
				{{ Form::select('sarana_kondisi_gudang', App\Questionnaire::$sarana_kondisi_gudang_option, $kuesioner->sarana_kondisi_gudang, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_nilai_gudang', '31. Berapa perkiraan nilai bangunan gudang?') }}
				{{ Form::select('sarana_nilai_gudang', App\Questionnaire::$sarana_nilai_gudang_option, $kuesioner->sarana_nilai_gudang, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_jumlah_mobil', '32. Berapa jumlah mobil pribadi/perusahaan yang dimiliki oleh Koperasi/perusahaan?') }}
				{{ Form::select('sarana_jumlah_mobil', App\Questionnaire::$sarana_jumlah_mobil_option, $kuesioner->sarana_jumlah_mobil, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				...
				{{ Form::select('sarana_nilai_mobil', App\Questionnaire::$sarana_nilai_mobil_option, $kuesioner->sarana_nilai_mobil, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_jumlah_angkutan', '34. Berapa jumlah mobil angkutan yang dimiliki oleh perusahaan anda?') }}
				{{ Form::select('sarana_jumlah_angkutan', App\Questionnaire::$sarana_jumlah_angkutan_option, $kuesioner->sarana_jumlah_angkutan, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('sarana_nilai_angkutan', '35. Berapa nilai perolehan/pasar mobil angkutan yang dimiliki oleh perusahaan anda?') }}
				{{ Form::select('sarana_nilai_angkutan', App\Questionnaire::$sarana_nilai_angkutan_option, $kuesioner->sarana_nilai_angkutan, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				...
				{{ Form::select('potensi_perluasan', App\Questionnaire::$potensi_perluasan_option, $kuesioner->potensi_perluasan, array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('efisiensi_standar', App\Questionnaire::$efisiensi_standar_option, $kuesioner->efisiensi_standar, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('efisiensi_jumlah', '38. Apakah jumlah mesin yang ada sudah mencukupi  dengan volume produk yang akan dihasilkan?') }}
				{{ Form::select('efisiensi_jumlah', App\Questionnaire::$efisiensi_jumlah_option, $kuesioner->efisiensi_jumlah, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				...
				{{ Form::select('efisiensi_kapasitas', App\Questionnaire::$efisiensi_kapasitas_option, $kuesioner->efisiensi_kapasitas, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('efisiensi_umur', '40. Berapa usia mayoritasmesin yang digunakan di Koperasi/perusahaan anda?') }}
				{{ Form::select('efisiensi_umur', App\Questionnaire::$efisiensi_umur_option, $kuesioner->efisiensi_umur, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('efisiensi_perawatan', '41. Apakah dilakukan perawatan mesin-mesin produksi di Koperasi/perusahaan anda?') }}
				{{ Form::select('efisiensi_perawatan', App\Questionnaire::$efisiensi_perawatan_option, $kuesioner->efisiensi_perawatan, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('efisiensi_rendemen', '42. Berapa nilai efisiensi produksi (rendemen) dari usaha yang dilakukan?') }}
				{{ Form::select('efisiensi_rendemen', App\Questionnaire::$efisiensi_rendemen_option, $kuesioner->efisiensi_rendemen, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('efisiensi_variasi', '43. Berapa jenis produk yang dihasilkan oleh Koperasi/perusahaan?') }}
				{{ Form::select('efisiensi_variasi', App\Questionnaire::$efisiensi_variasi_option, $kuesioner->efisiensi_variasi, array('class' => 'form-control')) }}
			</div>
			<h3>Kebutuhan energi</h3>
			<div class="form-group">
				{{ Form::label('energi_pln', '44. Berapa kapasitas listrik PLN yang dipakai di Koperasi/perusahaan anda?') }}
				{{ Form::select('energi_pln', App\Questionnaire::$energi_pln_option, $kuesioner->energi_pln, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('energi_genset', '45. Berapa kapasitas listrik Genset yang dipakai di Koperasi/perusahaan anda?') }}
				{{ Form::select('energi_genset', App\Questionnaire::$energi_genset_option, $kuesioner->energi_genset, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				...
				{{ Form::select('alternatif_energi', App\Questionnaire::$alternatif_energi_option, $kuesioner->alternatif_energi_option, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				...
				{{ Form::select('inovasi_produk', App\Questionnaire::$inovasi_produk_option, $kuesioner->inovasi_produk_option, array('class' => 'form-control')) }}
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('hubungan_pinjaman', App\Questionnaire::$hubungan_pinjaman_option, $kuesioner->hubungan_pinjaman, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				...
				{{ Form::select('hubungan_frekuensi', App\Questionnaire::$hubungan_frekuensi_option, $kuesioner->hubungan_frekuensi, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				...
				{{ Form::select('hubungan_internal', App\Questionnaire::$hubungan_internal_option, $kuesioner->hubungan_internal, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				...
				{{ Form::select('hubungan_eksternal', App\Questionnaire::$hubungan_eksternal_option, $kuesioner->hubungan_eksternal, array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('tk_jumlah', App\Questionnaire::$tk_jumlah_option, $kuesioner->tk_jumlah, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('tk_kompetisi', '69. Bagaimanakah kompetensi tenaga kerja di koperasi/perusahaan anda saat ini?') }}
				{{ Form::select('tk_kompetisi', App\Questionnaire::$tk_kompetisi_option, $kuesioner->tk_kompetisi, array('class' => 'form-control')) }}
			</div>
			<h3>Produktivitas Kerja</h3>
			<div class="form-group">
				{{ Form::label('produktif_jam', '70. Berapa lama jam kerja tenaga kerja di perusaahan anda saat ini?') }}
				{{ Form::select('produktif_jam', App\Questionnaire::$produktif_jam_option, $kuesioner->produktif_jam, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('produktif_shift', '71. Bagaimanakah shift (giliran kerja) diperusahaan anda saat ini?') }}
				{{ Form::select('produktif_shift', App\Questionnaire::$produktif_shift_option, $kuesioner->produktif_shift, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('produktif_upah', '72. Berapa standar upah tenaga kerja?') }}
				{{ Form::select('produktif_upah', App\Questionnaire::$produktif_upah_option, $kuesioner->produktif_upah, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				...
				{{ Form::select('fasilitas_tk', App\Questionnaire::$fasilitas_tk_option, $kuesioner->fasilitas_tk_option, array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				{{ Form::select('marketing_strategy', App\Questionnaire::$marketing_strategy_option, $kuesioner->marketing_strategy_option, array('class' => 'form-control')) }}
			</div>
			...
			<div class="form-group">
				...
				{{ Form::select('mix_product', App\Questionnaire::$mix_product_option, $kuesioner->mix_product, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('mix_price', '76. Bagaimanakah penerapan harga di Koperasi/perusahaan anda?') }}
				{{ Form::select('mix_price', App\Questionnaire::$mix_price_option, $kuesioner->mix_price, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('mix_place', '77. Bagaimanakah saluran distribusi produk Koperasi/perusahaan anda?') }}
				{{ Form::select('mix_place', App\Questionnaire::$mix_place_option, $kuesioner->mix_place, array('class' => 'form-control')) }}
			</div>
			<div class="form-group">
				{{ Form::label('mix_promotion', '78. Bagaimana penerapan promosi di koperasi/perusahaan Anda?') }}
				{{ Form::select('mix_promotion', App\Questionnaire::$mix_promotion_option, $kuesioner->mix_promotion, array('class' => 'form-control')) }}
			</div>
			<h3>Penguasaan Pasar</h3>
			<div class="form-group">
				{{ Form::label('market_share', '79. Bagaimanakah keadaan market share perusahaan anda saat ini?') }}
				{{ Form::select('market_share', App\Questionnaire::$market_share_option, $kuesioner->market_share, array('class' => 'form-control')) }}
			</div>
			<h3>Cakupan Pasar</h3>
			<div class="form-group">
				{{ Form::label('market_coverage', '80. Bagaimanakah cakupan pasar Koperasi/perusahaan anda saat ini?') }}
				{{ Form::select('market_coverage', App\Questionnaire::$market_coverage_option, $kuesioner->market_coverage, array('class' => 'form-control')) }}
			</div>
			<h3>Persaingan</h3>
			<div class="form-group">
				...
				{{ Form::select('market_competition', App\Questionnaire::$market_competition_option, $kuesioner->market_competition, array('class' => 'form-control')) }}
			</div>
		</div>
...
<div class="container mt-5">
    ...
    <div class="col-md-4 hidden-print text-right">
      {{ Form::open(['url' => action('QuestionnaireController@delete', $questionnaire->id), 'method' => 'delete']) }}
    ...
    <div class="row">
      <div class="col-md-9">
        <div class="card mb-5">
          <div class="card-header" id="data-umum">
        ...
        <div class="card mb-5">
          <div class="card-header" id="aspek-manajerial">
        ...
        <div class="card mb-5">
          <div class="card-header" id="aspek-produksi">
        ...
        <div class="card mb-5">
          <div class="card-header" id="aspek-keuangan">
        ...
        <div class="card mb-5">
          <div class="card-header" id="aspek-pemasaran">
      ...
      <div class="col-md-3">
        <div class="list-group sticky-top" style="top: 30px">
          <a href="#data-umum" class="list-group-item list-group-item-action active">Data Umum</a>
